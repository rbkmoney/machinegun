...
1. таймеры отдельным воркером, который будет поллить, и возможность получение по вторичному индексу из стораджа
1. автоподнятие упавших недопроцессивших машин
