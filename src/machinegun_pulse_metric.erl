...
create_metric(#mg_core_storage_get_start{name = {NS, _Caller, Type}}) ->
    [
        create_inc([mg, storage, NS, Type, get, start])
    ];
create_metric(#mg_core_storage_get_finish{name = {NS, _Caller, Type}, duration = Duration}) ->
    [
        create_inc([mg, storage, NS, Type, get, finish]),
        create_bin_inc([mg, storage, NS, Type, get, duration], duration, Duration)
    ];
create_metric(#mg_core_storage_put_start{name = {NS, _Caller, Type}}) ->
    [
        create_inc([mg, storage, NS, Type, put, start])
    ];
create_metric(#mg_core_storage_put_finish{name = {NS, _Caller, Type}, duration = Duration}) ->
    [
        create_inc([mg, storage, NS, Type, put, finish]),
        create_bin_inc([mg, storage, NS, Type, put, duration], duration, Duration)
    ];
create_metric(#mg_core_storage_search_start{name = {NS, _Caller, Type}}) ->
    [
        create_inc([mg, storage, NS, Type, search, start])
    ];
create_metric(#mg_core_storage_search_finish{name = {NS, _Caller, Type}, duration = Duration}) ->
    [
        create_inc([mg, storage, NS, Type, search, finish]),
        create_bin_inc([mg, storage, NS, Type, search, duration], duration, Duration)
    ];
create_metric(#mg_core_storage_delete_start{name = {NS, _Caller, Type}}) ->
    [
        create_inc([mg, storage, NS, Type, delete, start])
    ];
create_metric(#mg_core_storage_delete_finish{name = {NS, _Caller, Type}, duration = Duration}) ->
    [
